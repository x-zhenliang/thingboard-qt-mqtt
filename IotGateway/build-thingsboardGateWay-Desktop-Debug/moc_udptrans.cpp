/****************************************************************************
** Meta object code from reading C++ file 'udptrans.h'
**
...
#include "../thingsboardGateWay/udptrans/udptrans.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'udptrans.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 24, 16) // "slotsendFileData"

    },
    "ClientUdp\0slotReadData\0\0slotsendFileData"
};
...
void ClientUdp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ClientUdp *_t = static_cast<ClientUdp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotReadData(); break;
        case 1: _t->slotsendFileData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ClientUdp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ClientUdp.data,
      qt_meta_data_ClientUdp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClientUdp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientUdp.stringdata0))
        return static_cast<void*>(const_cast< ClientUdp*>(this));
