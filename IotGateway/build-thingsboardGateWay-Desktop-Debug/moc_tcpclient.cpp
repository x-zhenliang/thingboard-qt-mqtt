...
#include "../thingsboardGateWay/tcptrans/tcpclient.h"
...
QT_MOC_LITERAL(1, 10, 11), // "ProgressNum"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "count"
QT_MOC_LITERAL(4, 29, 4), // "over"
QT_MOC_LITERAL(5, 34, 9), // "SendError"
QT_MOC_LITERAL(6, 44, 5), // "error"
QT_MOC_LITERAL(7, 50, 13), // "StartTransfer"
QT_MOC_LITERAL(8, 64, 20), // "UpdateClientProgress"
QT_MOC_LITERAL(9, 85, 12), // "DisplayError"
QT_MOC_LITERAL(10, 98, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(11, 127, 15) // "slotReceiveFile"

    },
    "ClientTcp\0ProgressNum\0\0count\0over\0"
    "SendError\0error\0StartTransfer\0"
...
void ClientTcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ProgressNum((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        case 1: _t->SendError((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        case 5: _t->slotReceiveFile(); break;
        default: ;
        }
        ...
        {
            typedef void (ClientTcp::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTcp::ProgressNum)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTcp::SendError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClientTcp::ProgressNum(qint64 _t1, qint64 _t2)
{
...
// SIGNAL 1
void ClientTcp::SendError(QString _t1)
{
